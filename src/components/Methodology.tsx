...
import { Search, FileText, Rocket, Clock, CheckCircle, Users } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-3 gap-8 relative z-10">
            {steps.map((step, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className={`absolute -top-4 left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white font-bold text-sm z-20`}>
                  {index + 1}
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 mt-4">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r ${step.color} text-white text-sm font-medium mb-3`}>
                      <Clock size={16} />
                      {step.duration}
                    </div>
