    ...
    children: /* @__PURE__ */ jsxs(Container, { style: { padding: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxs("table", { className: "w-full flex justify-center mx-auto", children: [
        ...
        /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { align: "center", children: /* @__PURE__ */ jsxs(Row, { className: "table-cell h-[44px] w-[56px] align-bottom", children: [
          /* @__PURE__ */ jsx(Column, { className: "pr-[8px]", children: /* @__PURE__ */ jsx(Link, { href: "#", children: /* @__PURE__ */ jsx(
            Img,
            {
              alt: "Facebook",
              height: "36",
          ...
          /* @__PURE__ */ jsx(Column, { children: /* @__PURE__ */ jsx(Link, { href: "#", children: /* @__PURE__ */ jsx(
            Img,
            {
              alt: "Instagram",
              height: "36",
        ...
        /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { align: "center", children: /* @__PURE__ */ jsx(Text, { className: "mt-[4px] mb-0 font-semibold text-[16px] text-gray-500 leading-[24px]", children: "contact@automatisons.fr | +33 1 23 45 67 89" }) }) })
      ] })
    ] })
  }
) });
