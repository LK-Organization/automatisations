import { e as createAstro, f as createComponent, h as addAttribute, n as renderScript, l as renderHead, o as renderSlot, r as renderTemplate } from './astro/server_Dn19Kt8r.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                        */
...
const ui = {
  fr: {
    ...
    "hero.subtitle": "Nous optimisons votre entreprise grâce à des solutions d'automatisation personnalisées.",
    ...
    "exemples.assistant.subtitle": "Je demande simplement les infos client à mon assistant vocal.",
    ...
    "contact.meetingFormSubtitle": "Discutons de votre projet d’automatisation IA ",
    "contact.meetingFormDescription": "Grâce à l’automatisation intelligente vous libérez votre équipe des tâches répétitives. Nous simplifions vos processus (marketing, service client, emailing…) pour que vous puissiez vous concentrer sur ce qui compte vraiment : la croissance de votre entreprise.",
    "contact.name": "Nom",
    "contact.email": "Email",
    ...
    "faq.title": "FAQ",
    "faq.subtitle": "Les questions les plus fréquentes sur l'automatisation intelligente",
    "faq.q1.question": "Quels types de tâches peut-on automatiser dans une entreprise ?",
...
Vous avez une tâche spécifique en tête ? Contactez-nous pour une analyse gratuite sous 24h.`,
    "faq.q2.question": "L’automatisation IA est-elle compatible avec les logiciels que nous utilisons ?",
...
L’analyse de vos besoins et le devis sont gratuits, livrés en moins de 24h.`,
  ...
  en: {
    ...
    "hero.subtitle": "We optimize your business with customized automation solutions.",
    ...
    "contact.meetingFormSubtitle": "Let’s Talk About Your AI Automation Project",
    "contact.meetingFormDescription": "With smart automation, you free your team from repetitive tasks. We simplify your processes (marketing, customer service, emailing…) so you can focus on what really matters: growing your business.",
    "contact.name": "Name",
    "contact.email": "Email",
    "contact.message": "Message",
    "contact.send": "Send",
...
The analysis of your needs and the quote are free and delivered within 24 hours.`,
    ...
    "chatbot.welcome": "👋 Hello and welcome!\n If you're looking to save time, simplify your daily tasks, and automate what can be automated, you're in the right place.\n This assistant is here to help you discover our solutions or connect you with an expert.",
    "chatbot.default": "I understand your question, but I’d like to give you a more precise answer. Could you let me know if you're interested in:\n\n• Business process automation\n• Implementing AI agents\n• Our services and pricing\n• A specific industry\n\nOr contact our team directly at +33 6 48 09 15 11 for personalized advice!",
    "chatbot.greeting": "Hello! Nice to meet you. I'm here to answer all your questions about automation and artificial intelligence. What would you like to know?",
    "chatbot.thank_you": "You're welcome! Feel free to ask if you have more questions. I'm here to help you understand how automation can transform your business.",
    "chatbot.contact": "To contact us:\n\n📧 **Email**: contact@automatisons.com\n📞 **Phone**: +33 6 48 09 15 11\n📍 **Address**: Paris, France\n\nYou can also fill out our contact form on the website for a quick response. Would you like me to redirect you to the contact page?",
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(lang, "lang")}> <head><meta charset="UTF-8"><meta name="description"${addAttribute(description, "content")}><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta property="og:image" content="/brand.png"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><!-- Fonts --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet"><link rel="canonical"${addAttribute(`https://www.automatisons.fr${Astro2.url.pathname}`, "href")}><!-- Google tag (gtag.js) -->${renderScript($$result, "C:/Users/MohMost/Downloads/Sandbox/Projects/automatisations/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")}${renderHead()}</head> <body class="font-sans"> <main> <!-- Pass \`lang\` and \`t\` down to pages/components --> ${renderSlot($$result, $$slots["default"])} </main> <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KF9Z54W9" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> </body></html>`;
  ...
  return /* @__PURE__ */ jsx(
    motion.nav,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: getBackgroundStyle(), children: [
        /* @__PURE__ */ jsx("div", { className: "max-w-full mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center h-20", children: [
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 px-2 pt-2 pb-3 space-y-1 sm:px-3", children: [
              ...
              /* @__PURE__ */ jsx(
                "a",
                {
                  ...
                  children: /* @__PURE__ */ jsx("img", { src: switchLabel, alt: "", width: 30 })
                }
              )
            ] })
          }
...
const Footer = ({ lang }) => {
  ...
  return /* @__PURE__ */ jsx("footer", { className: "bg-gray-900 text-white py-12 footer", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
...
const Chatbot = ({ lang }) => {
  ...
  const knowledgeBase = t("chatbot.knowledge");
  const findBestResponse = (userMessage) => {
    const message = userMessage.toLowerCase();
    for (const key in knowledgeBase) {
      if (knowledgeBase[key].keywords.some((kw) => message.includes(kw))) {
  ...
  const formatTime = (date) => date.toLocaleTimeString(lang === "en" ? "en-US" : "fr-FR", {
    hour: "2-digit",
    minute: "2-digit"
  });
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    !isOpen && showLauncher && /* @__PURE__ */ jsxs(
      motion.button,
      {
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-primary-600 to-accent-500 text-white p-4 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: t("chatbot.title") }),
                /* @__PURE__ */ jsx("p", { className: "text-xs opacity-90", children: t("chatbot.subtitle") })
              ] })
            ] }),
