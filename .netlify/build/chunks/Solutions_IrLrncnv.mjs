  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 bg-gray-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-4", children: t("solutions.title") }),
        ...
        children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(solution.icon, { size: 28, className: "text-white" })
            }
          ),
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold text-gray-900 mb-3", children: t(solution.title) }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-4", children: t(solution.description) }),
          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: solution.features.map((featureKey, featureIndex) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600", children: t(featureKey) })
          ] }, featureIndex)) })
        ]
      },
      solution.title
