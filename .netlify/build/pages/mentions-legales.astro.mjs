...
const $$MentionsLegales = createComponent(($$result, $$props, $$slots) => {
  const lang = "fr";
  const title = "Mentions l\xE9gales \u2013 Automatisons - Agence IA & automatisation.";
